...
CREATE TABLE `credit_bank` (
  ...
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='银行';
...
CREATE TABLE `credit_email` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `customerNo` varchar(30) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '商户编号',
  ...
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='邮箱';
...
CREATE TABLE `credit_file` (
  ...
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='邮箱文件';
...
CREATE TABLE `credit_template` (
  `id` bigint(50) NOT NULL AUTO_INCREMENT,
  `due_date` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '到期还款日',
  `current_amount` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '本期应还款额',
  `credits` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '信用额度',
  `cash` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '取现额度',
  `last_amount` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `repayment` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '还款/退货/费用返还',
  `consumption` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '消费/取现/其他费用',
  `transaction_date` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '交易日期',
  `billing_date` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '记账日志',
  `transaction_description` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '交易说明',
  `transaction_amount` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '交易币种/金额',
  `accountable_amount` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '入账币种/金额',
  `prepaid_cash_amount` decimal(10,2) DEFAULT NULL COMMENT '预借现金额度',
  `details` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '账单明细',
  `cardtype_id` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '卡类型',
  `status` tinyint(4) DEFAULT NULL COMMENT '有效标志1有效0无效',
  `update_date` datetime DEFAULT NULL COMMENT '修改时间',
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
