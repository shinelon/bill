...
CREATE TABLE `credit_bank` (
  ...
  `for_short` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '简称',
  ...
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='银行';
...
CREATE TABLE `credit_template` (
  ...
  `create_date` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='邮件解析模板';
