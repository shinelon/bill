...
public class ParseMailImplTest {
	...
	public void test() {
		...
		JedisClusterUtils.saveBean(Constant.redisTemplateRuleCache + "CITIC_STANDARD", rules);
		CreditTemplate r = JedisClusterUtils.getBean(Constant.redisTemplateRuleCache + "CITIC_STANDARD",
