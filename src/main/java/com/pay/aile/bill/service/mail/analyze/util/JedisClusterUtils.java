...
public class JedisClusterUtils {
    private static Logger logger = LoggerFactory
            .getLogger(JedisClusterUtils.class);
    @Resource
    ...
    public static void saveString(String key, String val) {
        ...
        ValueOperations<String, String> vo = cacheUtils.redisTemplate
                .opsForValue();
        vo.set(key, val);
    }
    ...
    public static void saveString(String key, String val, long seconds) {
        ...
        cacheUtils.redisTemplate.opsForValue().set(key, val, seconds,
                TimeUnit.SECONDS);
    }
    ...
    public static void saveToQueue(String key, String val, long size) {
        ...
        ListOperations<String, String> lo = cacheUtils.redisTemplate
                .opsForList();
    ...
    public static List<String> getFromQueue(String key, long size) {
        ...
        boolean flag = cacheUtils.redisTemplate
                .execute((RedisCallback<Boolean>) connection -> {
    ...
    public static Double incrFloat(String key, double incrBy) {
        ...
        return cacheUtils.redisTemplate
                .execute((RedisCallback<Double>) connection -> {
    ...
    public static Set<Tuple> listSortedsetRev(String key, int start, int end) {
        ...
        return cacheUtils.redisTemplate
                .execute((RedisCallback<Set<Tuple>>) connection -> {
                    return connection.zRevRangeWithScores(key.getBytes(), start,
                            end);
                });
    }
    ...
    public static Long getRankRev(String key, String member) {
        ...
        return cacheUtils.redisTemplate
                .execute((RedisCallback<Long>) connection -> {
                    return connection.zRevRank(key.getBytes(),
                            member.getBytes());
                });
     ...
     *            成员名称
     */
    public static void saveToSortedset(String key, Double score,
            String member) {
    ...
    public static void delFromSortedset(String key, String member) {
        cacheUtils.redisTemplate
                .execute((RedisCallback<Long>) connection -> connection
                        .zRem(key.getBytes(), member.getBytes()));
     ...
     * @param clazz
     */
    public static <T> T getBeanFromMap(String key, String field,
            Class<T> clazz) {

        byte[] input = cacheUtils.redisTemplate
    ...
    public static <T> Long lpush(String key, T value) {
        ...
        return cacheUtils.redisTemplate.opsForList().leftPush(key,
    ...
    public static void hsetnx(String hName, String key, String value) {
        ...
        cacheUtils.redisTemplate.execute(
                (RedisCallback<Boolean>) connection -> connection.hSetNX(
                        key.getBytes(), key.getBytes(), value.getBytes()));
    ...
    public static void hashIncr(String hName, String key) {
        cacheUtils.redisTemplate.opsForHash().increment(hName, key, 1);
    }
