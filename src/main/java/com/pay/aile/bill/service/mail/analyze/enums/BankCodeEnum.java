...
public enum BankCodeEnum {
	...
	ABC("ABC", "农业"), BCM("BCM", "交通"), BOB("BOB", "北京"), BOC("BOC", "中国"), CCB("CCB", "建设"), CEB("CEB", "光大"), CIB(
			"CIB", "兴业"), CITIC("CITIC", "中信"), CMB("CMB", "招商"), CMBC("CMBC", "民生"), GDB("GDB", "广发"), HXB("HXB",
					"华夏"), ICBC("ICBC", "工商"), SDB("SDB", "深圳发展"), PSBC("PSBC", "邮储"), SPDB("SPDB", "浦发银行");
	;
