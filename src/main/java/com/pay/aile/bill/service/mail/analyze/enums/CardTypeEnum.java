...
public enum CardTypeEnum {
    PAB_DEFAULT("PAB_DEFAULT", BankCodeEnum.PAB, "平安银行信用卡"), CZB_DEFAULT(
            "CZB_DEFAULT", BankCodeEnum.CZB,
            "浙商银行信用卡"), BOB_DEFAULT("BOB_DEFAULT", BankCodeEnum.BOB,
                    "北京银行信用卡"), GDB_DEFAULT("GDB_DEFAULT", BankCodeEnum.GDB,
                            "广发银行信用卡"), BSB_DEFAULT("BSB_DEFAULT",
                                    BankCodeEnum.BSB, "包商银行信用卡"), ABC_DEFAULT(
