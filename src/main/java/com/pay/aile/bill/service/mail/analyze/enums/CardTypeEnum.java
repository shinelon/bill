...
public enum CardTypeEnum {
    BSB_DEFAULT("BSB_DEFAULT", BankCodeEnum.BSB, "包商银行信用卡"), ABC_DEFAULT(
            "ABC_DEFAULT", BankCodeEnum.ABC,
            "农业银行信用卡"), BCM_DEFAULT("BCM_DEFAULT", BankCodeEnum.BCM,
                    "交通银行信用卡"), CIB_DEFAULT("CIB_DEFAULT", BankCodeEnum.CIB,
                            "兴业银行信用卡"), CEB_GOLD("CEB_GOLD", BankCodeEnum.CCB,
                                    "光大信用卡金卡"), CEB_DEFAULT("CEB_DEFAULT",
                                            BankCodeEnum.CCB,
                                            "光大信用卡PDF"), CCB_LK("CCB_LK",
                                                    BankCodeEnum.CCB,
                                                    "建行龙卡"), CITIC_STANDARD(
                                                            "CITIC_STANDARD",
                                                            BankCodeEnum.CITIC,
